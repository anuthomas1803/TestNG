...
public class utility {
	...
	public	static FileInputStream f;// This is used to obtain input bytes from the file.

		// It represents the file input stream for reading data from the Excel file.

	public	static XSSFWorkbook w;// This represents the workbook instance, which refers to the entire Excel file.
